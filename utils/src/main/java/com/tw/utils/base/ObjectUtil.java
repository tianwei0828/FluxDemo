...
public final class ObjectUtil {
     ...
     *     this.bar = ObjectUtil.requireNonNull(bar, "bar must not be null");
     *     this.baz = ObjectUtil.requireNonNull(baz, "baz must not be null");
     * }
     * </pre></blockquote>
     *
     * @param obj     the object reference to check for nullity
    ...
    public static <T> void checkNonNull(T obj, String message) {
        if (obj == null)
            throw new NullPointerException(message);
    }
}
