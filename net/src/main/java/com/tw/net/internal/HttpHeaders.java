...
/**
 * 请求和响应头
 * Created by wei.tian on 2017/4/21.
 */

public class HttpHeaders {
    private Map<String, String> mHeaders;
    private Map<String, String> mAddHeaders;

    public HttpHeaders(Builder builder) {
        this.mHeaders = builder.mHeaders;
        this.mAddHeaders = builder.mAddHeaders;
    }
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            mAddHeaders = new ArrayMap<>();
        }

        /**
         * 设置唯一的请求头，如果同一个key 添加了 两次value ，则 新 value 会覆盖之前的 value
         *
         * @param key
         * @param value
         * @return
        ...
        public Builder addHeader(String key, String value) {
            StringUtil.checkNotBlank(key, "key is blank");
            StringUtil.checkNotBlank(value, "value is blank");
            mAddHeaders.put(key, value);
            return this;
        }

        public HttpHeaders build() {
            if (CollectionUtil.isEmpty(mHeaders) && CollectionUtil.isEmpty(mAddHeaders)) {
                throw new IllegalArgumentException("can't build HttpHeaders with no headers");
            }
